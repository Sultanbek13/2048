package com.sultandev.a2048.di
...
class SharedPrefModule {
    ...
    @[Singleton Provides]
    fun provideSharedPreferences(@ApplicationContext ctx: Context): SharedPreferences = ctx.getSharedPreferences("app_data", Context.MODE_PRIVATE)
